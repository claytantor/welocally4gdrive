...
function WELOCALLY_GeodbRecord (cfg) {	
...
WELOCALLY_GeodbRecord.prototype.initCfg = function(cfg) {
	var errors = [];
	if (!cfg) {
...
WELOCALLY_GeodbRecord.prototype.makeWrapper = function() { 
	// Build Widget
	var _instance = this;
...
WELOCALLY_GeodbRecord.prototype.load = function(placeJson) {
	var _instance = this;
...
WELOCALLY_GeodbRecord.prototype.initMapForPlace = function(place, map_canvas) {
...
WELOCALLY_GeodbRecord.prototype.setMapEvents = function(map){
...
WELOCALLY_GeodbRecord.prototype.makePlaceContent = function(selectedPlace, cfg) {
...
//for place selectors
WELOCALLY_GeodbRecord.prototype.show = function(selectedPlace) {	
	this.wrapper.html(this.makePlaceContent(selectedPlace, this.cfg));	  
	jQuery(this.wrapper).show();
};


WELOCALLY_GeodbRecord.prototype.refreshMap = function(searchLocation) {
	var _instance = this;
...
//use map status area
WELOCALLY_GeodbRecord.prototype.getStatusArea = function (){
	var _instance = this;
