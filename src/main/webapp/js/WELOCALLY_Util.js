...
*/
if (!window.WELOCALLY_Util) {
    window.WELOCALLY_Util = {
    	env: {
    		init: function(){
    	...
    	util: {	
			...
			trim: function (str) { 
	    			return WELOCALLY_Util.util.ltrim(WELOCALLY_Util.util.rtrim(str), ' '); 
			}, 
			ltrim: function (str) { 
			...
			guidGenerator: function() {
				return (WELOCALLY_Util.util.S4()+WELOCALLY_Util.util.S4()+"-"+
						WELOCALLY_Util.util.S4()+"-"+WELOCALLY_Util.util.S4()+"-"+
						WELOCALLY_Util.util.S4()+"-"+
						WELOCALLY_Util.util.S4()+WELOCALLY_Util.util.S4()+WELOCALLY_Util.util.S4());
			},
